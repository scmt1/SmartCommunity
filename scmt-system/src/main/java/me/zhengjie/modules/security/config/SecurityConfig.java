...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .antMatchers("/staticIndex/**").permitAll()
                .antMatchers("/swagger-resources/**").permitAll()
                .antMatchers("/webjars/**").permitAll()
                .antMatchers("/*/api-docs/**").permitAll()
                .antMatchers("/api/message/**").permitAll()
                .antMatchers("/api/actProcess/**/**").permitAll()

                .antMatchers("/api/appMain/**").permitAll()
                .antMatchers("/api/tLog/**").permitAll()
                .antMatchers("/api/tCompany/**").permitAll()
                // 文件
                ...
                .antMatchers("/api/menus/getLeftMenuTree").permitAll()
                .antMatchers("/api/basicMenuInformation/getFirstMenu").permitAll()
                .antMatchers("/magic/web").permitAll()
                .antMatchers("/magic/**").permitAll()
                //magic-api 接口前缀
                .antMatchers("/interface/**").permitAll()
                .antMatchers("/api/tFormGenerator/addFormData").permitAll()
